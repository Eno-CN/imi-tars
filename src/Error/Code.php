...
class Code
{
    ...
    const TARSSERVERNOSERVANTERR = -4; //服务器端无该Servant对象
    ...
    const TARSSERVERNOTFOUNDROUTEERR = -13; //服务器端无该路由对象
    ...
    public static $msgs = [
        ...
        self::TARSSERVERNOTFOUNDROUTEERR => '服务器端无该路由对象'
    ];

    public static function getMsg($code)
    {
        return self::$msgs[$code] ?? self::$msgs[self::TARSSERVERUNKNOWNERR];
    }
}
